<template>
  <section role="upcoming-section" class="flex flex-col h-64 lg:h-[500px] mt-4">
    <HeaderSectionComponent header-name="Proximos Estrenos" />
    <perfect-scrollbar
...
onBeforeMount(async () => {
  movie_list.value = await getMovieUpcominList()
  if (movie_list.value) {
